# ConceptMap — CDA TS vers FHIR instant, dateTime et date - POC - Mapping CDA to FHIR v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ConceptMap — CDA TS vers FHIR instant, dateTime et date**

## ConceptMap: ConceptMap — CDA TS vers FHIR instant, dateTime et date (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/mappingcdafhir/ConceptMap/DataTypes/CdaTSToFHIR | *Version*:0.1.0 |
| Draft as of 2026-04-14 | *Computable Name*:CdaTSToFHIR |
  ...
  "group" : [{
    ...
    "element" : [{
      ...
      "target" : [{
        ...
        "comment" : "TS.value est converti en valeur FHIR date (précision jour ou partielle : AAAA, AAAA-MM ou AAAA-MM-JJ)."
      }]
    }]
  },
  {
