# Mapping CDA vers FHIR - Étape 2 socle générique orienté CDA - Mapping CDA to FHIR (Preuve de concept) v0.1.0
...
```json
{
  ...
  "status" : "draft",
  "date" : "2026-07-28T11:21:01+00:00",
      ...
      "rule" : [{
        ...
        },
        {
          ...
          },
          {
            ...
            "source" : [{
              "context" : "patientCda",
              "element" : "sdtcDeceasedInd",
              "variable" : "indicator",
              "condition" : "patientCda.sdtcDeceasedTime.empty()"
            }],
            "rule" : [{
              "name" : "value",
              "source" : [{
