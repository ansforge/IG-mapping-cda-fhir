# ConceptMap — CDA INT → FHIR integer - POC - Mapping CDA to FHIR v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ConceptMap — CDA INT → FHIR integer**

## ConceptMap: ConceptMap — CDA INT → FHIR integer (Experimental) 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/mappingcdafhir/ConceptMap/DataTypes/CdaINTToInteger | *Version*:0.1.0 |
| Draft as of 2026-03-17 | *Computable Name*:CdaINTToInteger |

 
Correspondances documentaires INT.value → integer. 
