# Mapping de CDA Mesure de lEnfant vers FHIR Bundle (Source : Oliver Egger) - POC - Mapping CDA to FHIR v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Mapping de CDA Mesure de lEnfant vers FHIR Bundle (Source : Oliver Egger)**

## StructureMap: Mapping de CDA Mesure de lEnfant vers FHIR Bundle (Source : Oliver Egger) 

| | |
| :--- | :--- |
| *Official URL*:https://interop.esante.gouv.fr/ig/fhir/mappingcdafhir/StructureMap/CdaFrMDEToBundle | *Version*:0.1.0 |
| Draft as of 2025-10-20 | *Computable Name*:CDAFrMDEToBundle |
